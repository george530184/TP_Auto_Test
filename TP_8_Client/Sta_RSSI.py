...
__author__ = 'Jerry'
'''
Get From WlanAPI.dll:  WlanGetAvailableNetworkList() and rssi is in WLAN_BSS_ENTR():lRssi
################
Struct：
################
GUID
...
# DOT11_MAC_ADDRESS && dot11PhyTypes
...
def get_interface():
    ...
    ClientHandle = HANDLE()
    # 1 for xp; 2 for vista above
    ret = WlanOpenHandle(2, None, byref(NegotiatedVersion), byref(ClientHandle))
...
def get_BSSI():
    ...
    try:
        ...
        for iface in ifaces:
            ...
            ret2 = WlanGetNetworkBssList(ClientHandle, byref(iface.InterfaceGuid), None, None, True, None, byref(pAvailableNetworkList2))
            ...
            try:
                ...
                networks2 = customresize(avail_net_list2.NetworkBSS, avail_net_list2.NumberOfItems)
